...
8. Click on "Browse Files" and upload a text (.txt) file. (The sample_text.txt file in this repository can be used)
...
12. The "Clear Chat" button in the sidebar clears the chat.
13. If the checkbox beside "Show Database Logs" is clicked, the chat history is displayed in the sidebar. 
